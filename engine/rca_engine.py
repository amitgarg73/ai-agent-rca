"""
RCA engine — enriches an Incident with a structured call stack and root cause summary.
...
def build_annotated_call_stack(
    ...
    """
    # Find the offending tool name from the incident call_stack if Tool Timeout Loop
    root_tool = None
...
def summarize_incident(incident: Incident, session: dict) -> dict:
    """Return a human-readable summary dict for dashboard display."""
    duration_s = 0
